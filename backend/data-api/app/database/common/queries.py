...
INIT_STATEMENTS = (
    [] + ORGANIZATION_INIT_STATEMENTS + ITERATION_INIT_STATEMENTS + WORK_ITEM_INIT_STATEMENTS + USER_INIT_STATEMENTS
)

QUERIES = {**WORK_ITEM_QUERIES, **USER_QUERIES, **ORGANIZATION_QUERIES, **ITERATION_QUERIES}
